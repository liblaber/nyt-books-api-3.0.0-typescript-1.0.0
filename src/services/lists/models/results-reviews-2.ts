 ...
 */
export const resultsReviews2 = z.object({
...
/**
 *
 * @typedef  {ResultsReviews2} resultsReviews2
 * @property {string}
 * @property {string}
 * @property {string}
 * @property {string}
 */
export type ResultsReviews2 = z.infer<typeof resultsReviews2>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const resultsReviews2Response = z
  .object({
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const resultsReviews2Request = z
  .object({
